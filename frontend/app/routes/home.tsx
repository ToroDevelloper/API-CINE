...
export default function Home() {
  ...
  return (
    <div className="bg-[#131313] text-white min-h-screen">
      ...
      {!peliculaDestacada && (
        <section className="h-[85vh] bg-[#131313] flex items-center justify-center">
          <div className="text-center">
            <div className="mb-6">
              <Clapperboard className="w-20 h-20 text-[#E50914] mx-auto" />
            </div>
            <h1 className="text-6xl md:text-8xl font-extrabold mb-4 tracking-tight">CINEMA</h1>
            <p className="text-xl md:text-2xl text-[#e9bcb6] mb-8">Reserva de películas en línea</p>
            <div className="flex gap-4 justify-center">
              <Link
                to="/login"
                className="bg-[#E50914] hover:bg-[#c0000c] text-white font-semibold py-3 px-8 rounded transition-colors text-lg flex items-center gap-2"
              >
              ...
              <Link
                to="/register"
                className="bg-[#333] hover:bg-[#444] text-white font-semibold py-3 px-8 rounded transition-colors text-lg"
              >
                Registrarse
              </Link>
            </div>
